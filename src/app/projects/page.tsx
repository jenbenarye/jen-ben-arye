...
const projects = [
  ...
  },
  {
    ...
    year: "2024",
    blurb:
      "Automated RLHF pipelines to align multilingual LLMs w/ live human feedback @ MIT CSAIL. Advised by Prof. Jacob Andreas and Prof. Leshem Choshen.",
    tags: ["rlhf", "llm", "nlp"],
  },
  {
    ...
    year: "2025",
    blurb:
      "Studying how adversarial preference signals shift model alignment + behavior; stress-testing LLMs under adversarial feedback.",
    ...
    >
      ...
      >
        ...
        <Text
          ...
          color="#6a6a6a"
          paddingTop={{ base: "0.3rem", md: "0.5rem" }}
        >
          Things I've built
        </Text>
